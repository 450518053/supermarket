...
<script type="text/javascript">
	$(function() {
							...
							columns : [ [
									...
									},
									{
										...
										formatter : function rowformater(value,
												row, index) {
											return "<a href='./wxBackGround/PowerManage/UserModify.jsp'>修改</a>|<a href='#' target='iframe'>删除</a>";
										},
										hidden : false
									}, {
										field : 'paramTypeId',
		...
		var p = $("#UserInfo_list").datagrid('getPager');
		$(p).pagination({
	...
	<div>
		<form>
			<table class="usertable">
				...
				<tr>
					<td>所在城市：</td>
					<td><select class="easyui-combobox userselect">
							<option>重庆</option>
							<option>深圳</option>
					</select></td>
				</tr>
			</table>
			<div class="tablesave2">
				<input type="submit" value="查询" class="button blue"/>&nbsp;<input
					type="reset" value="重置" class="button blue" />
			</div>
		</form>
		<table id="UserInfo_list" class="easyui-datagrid" >
		</table>
	</div>
</body>
</html>
