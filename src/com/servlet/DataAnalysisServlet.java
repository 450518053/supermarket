...
public class DataAnalysisServlet extends HttpServlet{
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		StringBuffer sb = new StringBuffer("finish \r\n");
		
		String start_time = req.getParameter("start_time");
		String end_time = req.getParameter("end_time");
		
		
		record =new DataManagerDao().getDataSet(start_time, end_time);
		...
		sb.append(printfLKitemset ( lItemset)) ;
		  ...
		  while ( endTag != true )
		 {
			 ...
			 if(lkItemset.size() != 0 )
				 sb.append(printfLKitemset ( lkItemset)) ;
...
//	{
////		List<List<String>> list = FileReader.getDatabase();
...
//	}
	...
	private static List<List<String>> getLItemset ( Map<List<String>, Integer> lItemset )
	{
	 ...
	 private static StringBuffer printfLKitemset ( Map<List<String> , Integer> lkItemset )
	 {
